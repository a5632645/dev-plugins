...
// One-pole slew time constants in milliseconds.
static constexpr float kDryDelaySlewMs = 130.0f;
static constexpr float kMixSlewMs = 40.0f;
static constexpr float kHopSlewMs = 40.0f;
static constexpr float kStretchSlewMs = 40.0f;
