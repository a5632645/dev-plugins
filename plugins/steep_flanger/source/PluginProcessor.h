...
using Float32x4 = qwqdsp_psimd::Vec4f32;
using Int32x4 = qwqdsp_psimd::Vec4i32;
using Float32x8 = qwqdsp_psimd::Vec8f32;
using Int32x8 = qwqdsp_psimd::Vec8i32;
...
private:
    ...
    float left_fb_{};
    float right_fb_{};
    qwqdsp_filter::OnePoleTPTSimd<Float32x4> damp_;
    float damp_lowpass_coeff_{1.0f};
    float last_damp_lowpass_coeff_{1.0f};

    // barberpole
    qwqdsp_filter::StereoIIRHilbertDeeperCpx<Float32x4> hilbert_complex_;
